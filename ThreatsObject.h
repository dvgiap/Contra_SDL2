...
public:
	...
	void MakeBullet(SDL_Renderer* screen, const int& x_limit);
	void RemoveBullet(const int& idx);
	void set_ableshoot(const bool& set_shoot) { able_shoot = set_shoot; }
	bool get_shoot() const { return able_shoot; }
...
private:
	...
	int type_move_;
	int animation_a_; // giới hạn vùng di chuyển của dynamic threat
	int animation_b_;
	Input input_type_;
